...
public class TodoController {
	...
	public ResponseEntity<?> findTodoList() {
		try {
			...
			ResponseDTO<TodoDTO> response = ResponseDTO.<TodoDTO>builder().error(">>> 검색 에러: " + e.getMessage())
					.build();
			return ResponseEntity.badRequest().body(response);
		}
	}
	...
	public ResponseEntity<?> updateTodo(@RequestBody TodoDTO dto) {
		try {
			...
			ResponseDTO<TodoDTO> response = ResponseDTO.<TodoDTO>builder().error(">>> 수정 에러: " + e.getMessage())
					.build();
			return ResponseEntity.badRequest().body(response);
		}
	}
	...
	public ResponseEntity<?> selectAll() {
		try {
			...
			ResponseDTO<TodoDTO> response = ResponseDTO.<TodoDTO>builder().error(">>> Select All 에러: " + e.getMessage())
					.build();
			return ResponseEntity.badRequest().body(response);
		}
	}

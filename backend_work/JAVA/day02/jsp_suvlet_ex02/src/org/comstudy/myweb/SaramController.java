...
// web.xml에 servlet-mapping 해주면 어노테이션 생략 가능.
@WebServlet("/saram/*")
public class SaramController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String viewName = "/WEB-INF/views/saram/list.jsp"; // view 역할을 하는 JSP페이지의 위치 / WEB-INF는 외부에서 접근 불가
		RequestDispatcher view = req.getRequestDispatcher(viewName);
		// Forward - Servlet 페이지에서 하는 일을 뷰 JSP 페이지로 위임.
